...
class SENet(nn.Module):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.classifier_root = None
        self.classifier_vowel = None
        self.classifier_constant = None
    ...
    def forward(self, x):
        ...
        y = self.classifier(v)
        ###New
        y_r = self.classifier_root(v)
        y_v = self.classifier_vowel(v)
        y_c = self.classifier_constant(v)
        return y_r, y_v, y_c
